...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>SEO Keyword Suggest - Keyword Tool</title>
    <link
...
div.pagination{font-size:11px;text-align:center;padding:2px 4px 2px 0;color:#ccc}div.pagination a{color:#ccc;text-decoration:none;border:1px solid #999;padding:2px 4px 2px 3px;margin:0 3px 0 3px;background-color:#000;line-height:24px}div.pagination a:active,div.pagination a:hover{color:#fff;background-color:#f90;text-decoration:none}div.pagination span.current{padding:2px 4px 2px 3px;margin:0 3px 0 3px;border:1px solid #f60;font-weight:700;color:#fff;background-color:#f90}div.pagination span.disabled{display:none}	
	</style>
...
<form name="searchbox" id="searchbox" action="keyword_suggest.php" onsubmit="return FormSubmit(event);"  method="POST">
  ...
  <div id="progress" class="bg-blue-600 h-1" style="width:0%;height:10px;"></div>
            ...
            <textarea id=queryoutput style="display:none;">This ian opensource project available at https://github.com/rmak78 </textarea><br>
</form> 
			</div>           
            <p
